...
**Status:** READY-TO-LAUNCH v7.2 (post-compute amendment; codex-v7-review-1 FAIL (2 P1 + 1 P2) and codex-v7-review-2 FAIL (persistent 4-cell refs at lines 155/160/283; stale count at line 431; sweep/queue still said 8/80; determinism check claimed analyzer-layer but absent; Row 6 trigger list missing determinism) both discharged in-place; scope = budget=40 primary-confirmatory cell; supporting cells {5, 10, 20} deferred to §2d-supplemental; partial-run count corrected everywhere to 18/80 with full breakdown (5/5/4/4 at budgets 5/10/20/40); determinism check implemented as committed script `scripts/check_v2d_overlap_determinism.sh`) · target commit `a16b4b2` (v6 engineering was `ee44b1c`; v7 scope-amendment was `fb179ce`; v7.1 was `5512815`) · 2026-04-24.
